...
public class WallCommand {
	...
	private static final SimpleCommandExceptionType ERROR = new SimpleCommandExceptionType(new TextComponentTranslation("commands.mapmakingtools.build.wall.error"));

	public static void register(CommandDispatcher<CommandSource> dispatcher) {
		dispatcher.register(Commands.literal("/wall").requires((requirement) -> {
	...
	private static int setBlock(CommandSource source, BlockStateInput block) throws CommandSyntaxException {
		...
		source.sendFeedback(new TextComponentTranslation("commands.mapmakingtools.build.wall.success", blocks).applyTextStyle(TextFormatting.ITALIC), true);
