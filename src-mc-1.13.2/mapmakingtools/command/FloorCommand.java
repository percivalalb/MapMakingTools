...
public class FloorCommand {
	...
	private static final SimpleCommandExceptionType ERROR = new SimpleCommandExceptionType(new TextComponentTranslation("commands.mapmakingtools.build.floor.error"));

	public static void register(CommandDispatcher<CommandSource> dispatcher) {
		dispatcher.register(Commands.literal("/floor").requires((requirement) -> {
	...
	private static int setBlock(CommandSource source, BlockStateInput block) throws CommandSyntaxException {
		...
		source.sendFeedback(new TextComponentTranslation("commands.mapmakingtools.build.floor.success", blocks).applyTextStyle(TextFormatting.ITALIC), true);
