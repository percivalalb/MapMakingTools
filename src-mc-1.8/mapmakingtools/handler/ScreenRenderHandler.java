...
public class ScreenRenderHandler {
	...
	public void onPreRenderGameOverlay(RenderGameOverlayEvent.Pre event) {
		...
		if (event.type == RenderGameOverlayEvent.ElementType.HELMET && stack != null && stack.getItem() == ModItems.editItem && stack.getMetadata() == 0 && PlayerAccess.canEdit(ClientHelper.mc.thePlayer)) {
	    	...
	    	if(event.type == RenderGameOverlayEvent.ElementType.HELMET) {
	    		...
	    		if(ClientHelper.mc.currentScreen instanceof GuiChat) {
	    			...
	    			for(int i = 0; i < BlockList.getListSize(); ++i) {
	    				...
	    				if(mouseX > 4 + 16 * column + renderOffset && mouseX < 4 + 16 * (column + 1) + renderOffset && mouseY > 4 + 16 * row && mouseY < 4 + 16 * (row + 1))
	    					drawHoveringText(Arrays.asList(EnumChatFormatting.GREEN + item.getDisplayName(), EnumChatFormatting.ITALIC + String.format("%s %s", Block.blockRegistry.getNameForObject(Block.getBlockFromItem(item.getItem())), item.getItemDamage())), mouseX, mouseY, width, height, ClientHelper.mc.fontRendererObj);
	    				column++;
	    			}
	...
	protected void drawGradientRect(int left, int top, int right, int bottom, int startColor, int endColor) {
        ...
        worldrenderer.addVertex((double)right, (double)top, (double)100);
        worldrenderer.addVertex((double)left, (double)top, (double)100);
        worldrenderer.setColorRGBA_F(f5, f6, f7, f4);
        worldrenderer.addVertex((double)left, (double)bottom, (double)100);
        worldrenderer.addVertex((double)right, (double)bottom, (double)100);
        tessellator.draw();
	...
	public void drawTexturedModalRect(int x, int y, int textureX, int textureY, int width, int height) {
        ...
        WorldRenderer worldrenderer = tessellator.getWorldRenderer();
        worldrenderer.startDrawingQuads();
        worldrenderer.addVertexWithUV((double)(x + 0), (double)(y + height), (double)100, (double)((float)(textureX + 0) * f), (double)((float)(textureY + height) * f1));
        worldrenderer.addVertexWithUV((double)(x + width), (double)(y + height), (double)100, (double)((float)(textureX + width) * f), (double)((float)(textureY + height) * f1));
        worldrenderer.addVertexWithUV((double)(x + width), (double)(y + 0), (double)100, (double)((float)(textureX + width) * f), (double)((float)(textureY + 0) * f1));
        worldrenderer.addVertexWithUV((double)(x + 0), (double)(y + 0), (double)100, (double)((float)(textureX + 0) * f), (double)((float)(textureY + 0) * f1));
        tessellator.draw();
    }
