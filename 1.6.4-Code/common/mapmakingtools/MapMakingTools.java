...
import mapmakingtools.common.flipped.FlippedBed;
import mapmakingtools.common.flipped.FlippedButton;
import mapmakingtools.common.flipped.FlippedChest;
import mapmakingtools.common.flipped.FlippedDispenser;
import mapmakingtools.common.flipped.FlippedDropper;
import mapmakingtools.common.flipped.FlippedFenceGate;
import mapmakingtools.common.flipped.FlippedFurnace;
import mapmakingtools.common.flipped.FlippedHopper;
import mapmakingtools.common.flipped.FlippedLadder;
import mapmakingtools.common.flipped.FlippedPoweredRail;
import mapmakingtools.common.flipped.FlippedPumpkin;
...
import mapmakingtools.common.flipped.FlippedSignPost;
import mapmakingtools.common.flipped.FlippedSignWall;
import mapmakingtools.common.flipped.FlippedStairs;
import mapmakingtools.common.flipped.FlippedStoneSlab;
import mapmakingtools.common.flipped.FlippedTorch;
import mapmakingtools.common.flipped.FlippedTrapdoor;
import mapmakingtools.common.flipped.FlippedTripwireSource;
import mapmakingtools.common.flipped.FlippedVanillaTrack;
...
import mapmakingtools.common.killentities.KillMobs;
...
public class MapMakingTools {
	...
	public void modsLoaded(FMLPostInitializationEvent par1) {
		...
		FlippedManager.registerFlippedHandler(Block.fenceGate.blockID, new FlippedFenceGate());
		FlippedManager.registerFlippedHandler(Block.ladder.blockID, new FlippedLadder());
		FlippedManager.registerFlippedHandler(Block.furnaceIdle.blockID, new FlippedFurnace());
		FlippedManager.registerFlippedHandler(Block.furnaceBurning.blockID, new FlippedFurnace());
		FlippedManager.registerFlippedHandler(Block.dropper.blockID, new FlippedDropper());
		FlippedManager.registerFlippedHandler(Block.dispenser.blockID, new FlippedDispenser());
		FlippedManager.registerFlippedHandler(Block.trapdoor.blockID, new FlippedTrapdoor());
		FlippedManager.registerFlippedHandler(Block.pumpkin.blockID, new FlippedPumpkin());
		FlippedManager.registerFlippedHandler(Block.pumpkinLantern.blockID, new FlippedPumpkin());
		FlippedManager.registerFlippedHandler(Block.woodenButton.blockID, new FlippedButton());
		FlippedManager.registerFlippedHandler(Block.stoneButton.blockID, new FlippedButton());
		FlippedManager.registerFlippedHandler(Block.tripWireSource.blockID, new FlippedTripwireSource());
		FlippedManager.registerFlippedHandler(Block.stairsWoodOak.blockID, new FlippedStairs());
		FlippedManager.registerFlippedHandler(Block.stairsWoodSpruce.blockID, new FlippedStairs());
		FlippedManager.registerFlippedHandler(Block.stairsWoodBirch.blockID, new FlippedStairs());
		FlippedManager.registerFlippedHandler(Block.stairsWoodJungle.blockID, new FlippedStairs());
		FlippedManager.registerFlippedHandler(Block.stairsBrick.blockID, new FlippedStairs());
		FlippedManager.registerFlippedHandler(Block.stairsStoneBrick.blockID, new FlippedStairs());
		FlippedManager.registerFlippedHandler(Block.stairsCobblestone.blockID, new FlippedStairs());
		FlippedManager.registerFlippedHandler(Block.stairsNetherBrick.blockID, new FlippedStairs());
		FlippedManager.registerFlippedHandler(Block.stairsSandStone.blockID, new FlippedStairs());
		FlippedManager.registerFlippedHandler(Block.stairsNetherQuartz.blockID, new FlippedStairs());
		FlippedManager.registerFlippedHandler(Block.signPost.blockID, new FlippedSignPost());
		FlippedManager.registerFlippedHandler(Block.signWall.blockID, new FlippedSignWall());
		FlippedManager.registerFlippedHandler(Block.rail.blockID, new FlippedVanillaTrack());
		FlippedManager.registerFlippedHandler(Block.railPowered.blockID, new FlippedPoweredRail());
		FlippedManager.registerFlippedHandler(Block.railDetector.blockID, new FlippedPoweredRail());
		FlippedManager.registerFlippedHandler(Block.railActivator.blockID, new FlippedPoweredRail());
		//TODO FlippedManager.registerFlippedHandler(Block.bed.blockID, new FlippedBed());
