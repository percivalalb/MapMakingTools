...
public class FlippedVanillaTrack implements IPasteFlip {
	...
	private static int[] NORTH = new int[] {1, 2, 9};
	private static int[] EAST = new int[] {0, 5, 7};
	private static int[] SOUTH = new int[] {1, 3, 6};
	private static int[] WEST = new int[] {0, 4, 8};
