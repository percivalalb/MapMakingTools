...
public class FilterServerItemSpawner implements IServerFilter {

	public static Map<String, ItemInventory> invMap = new Hashtable<String, ItemInventory>();
	...
	public void addSlots(ContainerFilter containerFilter) {
	    ...
	    containerFilter.putStackInSlot(0, SpawnerHelper.getItemType(containerFilter.player.worldObj.getBlockTileEntity(containerFilter.x, containerFilter.y, containerFilter.z)));
	}
	...
	public ItemInventory getInventory(ContainerFilter player) {
		String username = PlayerHelper.usernameLowerCase(player.player);
	    if(!invMap.containsKey(player)) {
	    	invMap.put(username, new ItemInventory(1));
	    }
	...
	public class ItemInventory implements IInventory {
		...
		public ItemInventory(int inventorySize) {
