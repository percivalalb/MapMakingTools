...
public class BabyMonsterClientFilter extends IFilterClientSpawner {
	...
	public String getIconPath() {
		return "mapmakingtools:babymonster";
	}
	...
	public void actionPerformed(IGuiFilter gui, GuiButton button) {
		...
		if (button.enabled) {
            switch (button.id) {
                case 0:
                	MapMakingTools.NETWORK_MANAGER.sendPacketToServer(new PacketBabyMonster(gui.getX(), gui.getY(), gui.getZ(), this.btn_covert.getData() == 0 ? false : true, this.minecartIndex));
