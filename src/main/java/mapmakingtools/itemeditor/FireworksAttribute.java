    ...
    public Supplier<Callable<IItemAttributeClient>> client() {
        return () -> () -> new IItemAttributeClient() {
            ...
            public void init(Screen screen, Consumer<Widget> add, Consumer<PacketBuffer> update, Consumer<Integer> pauseUpdates, final ItemStack stack, int x, int y, int width, int height) {
                ...
                this.typeList.setValues(FireworkRocketItem.Shape.values(), (v) -> I18n.format("item.minecraft.firework_star.shape." + v.getShapeName()), this.typeList);
                ...
                this.mainColorsList.setValues(DyeColor.values(), (v) -> I18n.format(v.getTranslationKey()), this.mainColorsList);
                ...
                this.fadeColorsList.setValues(DyeColor.values(), (v) -> I18n.format(v.getTranslationKey()), this.fadeColorsList);
                ...
                this.trailBtn = new CheckboxButton(x + 34, y + 14 * 5 + 43, 20, 20, "", false);
                this.flickerBtn = new CheckboxButton(x + 101, y + 14 * 5 + 43, 20, 20, "", false);

                this.addBtn = new SmallButton(x + width - 90, y + 14 * 5 + 43, 80, 16, "Add Explosion", (btn) -> {
            ...
            public void render(Screen screen, int x, int y, int width, int height) {
                ...
                font.drawString(I18n.format("item.minecraft.firework_rocket.flight"), x + 6, y + 17, 16777120);
                font.drawString("Shape", x + 4, y + 32, 16777120);
                font.drawString("Colours", x + 108, y + 32, 16777120);
                font.drawString("Fade Colours", x + 109 + Math.max((width - 105) / 2, 82), y + 32, 16777120);
                font.drawString("Trail:", x + 6, y + 14 * 5 + 47, 16777120);
                font.drawString("Flicker:", x + 63, y + 14 * 5 + 47, 16777120);
            }
