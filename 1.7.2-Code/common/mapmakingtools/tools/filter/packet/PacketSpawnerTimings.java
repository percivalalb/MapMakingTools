 ...
 */
public class PacketSpawnerTimings extends IPacket {
	...
	public void write(DataOutputStream data) throws IOException {
		...
		data.writeUTF(this.minDelay);
		data.writeUTF(this.maxDelay);
		data.writeUTF(this.spawnRadius);
		data.writeUTF(this.spawnCount);
		data.writeUTF(this.entityCap);
		data.writeUTF(this.detectionRange);
	}
