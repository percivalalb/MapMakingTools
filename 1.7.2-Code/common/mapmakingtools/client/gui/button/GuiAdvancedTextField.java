 ...
 */
public class GuiAdvancedTextField extends Gui {
...
**/
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            //MAP MAKING TOOLS (START)
	        ScaledResolution scaling = new ScaledResolution(ClientHelper.mc.gameSettings, ClientHelper.mc.displayWidth, ClientHelper.mc.displayHeight);
    		...
    		this.field_146211_a.drawStringWithShadow(this.getText(), l - this.field_146211_a.getStringWidth(this.getText().substring(0, this.lineScrollOffset)), i1, i);
            ...
            if (flag1 && !flag2) {
            	int u = l + this.field_146211_a.getStringWidth(s.substring(0, k));
                this.field_146211_a.drawStringWithShadow("_", u, i1, i);
            }

            if (flag1 && flag2) {
                int l1 = l + this.field_146211_a.getStringWidth(s.substring(0, k));
                this.drawCursorVertical(l1, i1 - 1, l1 - 1, i1 + 1 + this.field_146211_a.FONT_HEIGHT);
            }
