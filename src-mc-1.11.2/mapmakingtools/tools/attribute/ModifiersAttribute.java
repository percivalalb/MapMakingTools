...
public class ModifiersAttribute extends IItemAttribute {
	...
	private Modifier ATTACK_DAMAGE = new Modifier(SharedMonsterAttributes.ATTACK_DAMAGE, "Weapon modifier", ADD_OPERATION, itemModifierUUID);
	private Modifier KNOCKBACK_RESISTANCE = new Modifier(SharedMonsterAttributes.KNOCKBACK_RESISTANCE, "Weapon modifier", ADD_OPERATION, itemModifierUUID);
	private Modifier MAX_HEALTH = new Modifier(SharedMonsterAttributes.MAX_HEALTH, "Weapon modifier", MULT_PERCENTAGE_OPERATION, itemModifierUUID);
	private Modifier MOVEMENT_SPEED = new Modifier(SharedMonsterAttributes.MOVEMENT_SPEED, "Weapon modifier", MULT_PERCENTAGE_OPERATION, itemModifierUUID);
	private Modifier FOLLOW_RANGE = new Modifier(SharedMonsterAttributes.FOLLOW_RANGE, "Weapon modifier", MULT_PERCENTAGE_OPERATION, itemModifierUUID);
