...
public class GuiItemEditor extends GuiContainer implements IGuiItemEditor {
    ...
    public void initGui() {
    	...
    	if(itemCurrent != null)
    		itemCurrent.initGui(this, 150, this.guiTop, this.guiLeft + this.xSize - 150, this.ySize);
	...
	@Override
    protected void mouseMovedOrUp(int xMouse, int yMouse, int p_146286_3_) {
    	xMouse = (int)(xMouse / this.getScaleFactor());
		yMouse = (int)(yMouse / this.getScaleFactor());
		super.mouseMovedOrUp(xMouse, yMouse, p_146286_3_);
    }
