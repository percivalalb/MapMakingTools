...
public class SpawnerTimingClientFilter extends IFilterClientSpawner {
	...
	public String getIconPath() {
		return "mapmakingtools:spawnerTimings";
	}
	...
	public void initGui(IGuiFilter gui) {
        ...
        this.txt_minDelay = new GuiTextField(gui.getFont(), topX + 20, topY + 37, 90, 20);
        this.txt_minDelay.setMaxStringLength(7);
        this.txt_minDelay.setText(minDelayText);
        this.txt_maxDelay = new GuiTextField(gui.getFont(), topX + 120, topY + 37, 90, 20);
        this.txt_maxDelay.setMaxStringLength(7);
        this.txt_maxDelay.setText(maxDelayText);
        this.txt_spawnRadius = new GuiTextField(gui.getFont(), topX + 120, topY + 72, 90, 20);
        this.txt_spawnRadius.setMaxStringLength(7);
        this.txt_spawnRadius.setText(maxDelayText);
        this.txt_spawnCount = new GuiTextField(gui.getFont(), topX + 20, topY + 72, 90, 20);
        this.txt_spawnCount.setMaxStringLength(7);
        this.txt_spawnCount.setText(spawnCountText);
        this.txt_entityCap = new GuiTextField(gui.getFont(), topX + 20, topY + 107, 90, 20);
        this.txt_entityCap.setMaxStringLength(7);
        this.txt_entityCap.setText(entityCapText);
        this.txt_detectionRange = new GuiTextField(gui.getFont(), topX + 120, topY + 107, 90, 20);
	...
	public void actionPerformed(IGuiFilter gui, GuiButton button) {
		...
		if (button.enabled) {
            switch (button.id) {
                case 0:
                	MapMakingTools.NETWORK_MANAGER.sendPacketToServer(new PacketSpawnerTimings(gui.getX(), gui.getY(), gui.getZ(), this.txt_minDelay.getText(), this.txt_maxDelay.getText(), this.txt_spawnRadius.getText(), this.txt_spawnCount.getText(), this.txt_entityCap.getText(), this.txt_detectionRange.getText()));
