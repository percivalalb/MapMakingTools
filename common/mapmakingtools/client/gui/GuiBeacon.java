 ...
 */
public class GuiBeacon extends GuiScreen {
	
    private String TITLE = "Edit Beacons";
    ...
    public GuiBeacon(EntityPlayer var1, int x, int y, int z) {
    ...
    protected void actionPerformed(GuiButton var1){
        if (var1.enabled) {
        	if(var1.id == 0) {
        		PacketTypeHandler.populatePacketAndSendToServer(new PacketBeaconModify(x, y, z, 8, 7, 9));
    ...
    public void drawScreen(int var1, int var2, float var3) {
        ...
        this.fontRenderer.drawString("Primary Effect:", var4, var5, 4210752);
