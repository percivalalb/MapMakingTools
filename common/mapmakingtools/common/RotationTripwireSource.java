...
public class RotationTripwireSource implements IPasteRotate {

	private static int[] NORTH = new int[] {2};
	private static int[] EAST = new int[] {3};
	private static int[] SOUTH = new int[] {0};
	private static int[] WEST = new int[] {1};
