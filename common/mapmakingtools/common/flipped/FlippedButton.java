 ...
 */
public class FlippedButton implements IPasteFlip {

	private static int[] NORTH = new int[] {3, 11};
	private static int[] EAST = new int[] {2, 10};
	private static int[] SOUTH = new int[] {4, 12};
