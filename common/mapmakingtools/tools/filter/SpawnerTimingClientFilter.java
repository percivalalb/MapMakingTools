...
public class SpawnerTimingClientFilter extends IFilterClientSpawner {
	...
	public void actionPerformed(IGuiFilter gui, GuiButton button) {
		...
		if (button.enabled) {
            switch (button.id) {
                case 0:
                	//TODO MapMakingTools.NETWORK_MANAGER.sendPacketToServer(new PacketSpawnerTimings(gui.getX(), gui.getY(), gui.getZ(), txt_xPosition.getText(), txt_yPosition.getText(), txt_zPosition.getText(), (btn_type.displayString.equals("Relative") ? true : false)));
