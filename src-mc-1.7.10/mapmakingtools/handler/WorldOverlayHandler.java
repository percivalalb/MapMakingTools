...
public class WorldOverlayHandler {
	...
	public void onWorldRenderLast(RenderWorldLastEvent event) {
		if(!PlayerAccess.canEdit(mc.thePlayer) || !ClientData.playerData.hasSelectedPoints() || !(mc.thePlayer.getHeldItem() != null && mc.thePlayer.getHeldItem().getItem() == ModItems.editItem && mc.thePlayer.getHeldItem().getItemDamage() == 0))
			return;
		GL11.glPushMatrix();
